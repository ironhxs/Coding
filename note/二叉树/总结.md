...
- **BST 修剪**：节点值 < low 不能直接丢弃，其右子树可能有合法节点
- **累加树**：反中序遍历（右-中-左），用累加和更新节点值
...
- 669 修剪二叉搜索树 — [代码](../../code/二叉树/669%20修剪二叉搜索树.cpp) | [LeetCode](https://leetcode.cn/problems/trim-a-binary-search-tree/)
- 108 将有序数组转换为二叉搜索树 — [代码](../../code/二叉树/108%20将有序数组转换为二叉搜索树.cpp) | [LeetCode](https://leetcode.cn/problems/convert-sorted-array-to-binary-search-tree/)
- 538 把二叉搜索树转换为累加树 — [代码](../../code/二叉树/538%20把二叉搜索树转换为累加树.cpp) | [LeetCode](https://leetcode.cn/problems/convert-bst-to-greater-tree/)
